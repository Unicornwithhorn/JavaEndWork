...
//        в describerParameters - brand, modelName, color, CPUModel, operatingSystem
        ...
        choiceCustomer(laptops, choosenParameters, typeParameters);
    }

    private static void choiceCustomer(ArrayList<Laptop> laptops, HashMap<String, Set<String>> choosenParameters, ArrayList<TypeParameter> typeParameters) {
        ...
        while (!choice.equals("13")) {
            ...
            switch (choice){
                ...
                case "9": Menu.choice(laptops, choosenParameters, typeParameters.get(8));
                    continue;
                case "11": Menu.addResults(laptops, choosenParameters);
                    continue;
                case "12":
